...
WHERE crs.course_id = tr.course_id and stf.staff_id=crs.staff_id and tr.room_id = loc.room_id and loc.f_id = fac.f_id and crs.course_id='".$_POST["course_id"]."'";  
     ...
     while($row = mysqli_fetch_assoc($result))  
      ...
      $fac = "SELECT DISTINCT f_id , bld_name FROM faculty_table WHERE f_id!=0 and f_id NOT IN (SELECT f_id FROM location_table loc,teach_in_relation tir WHERE tir.room_id=loc.room_id and course_id=".$_POST["course_id"].")   ";  
